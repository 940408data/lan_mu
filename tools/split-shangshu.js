/**
 * 将尚书正义合并文本按卷分割为单独文件
 * 输入：input_data/十三经注疏/shangshu_merged.txt
 * 输出：input_data/十三经注疏/shangshu_vols/vol_XX.txt
 */
const fs = require('fs');
const path = require('path');

const mergedFile = 'input_data/十三经注疏/shangshu_merged.txt';
const outDir = 'input_data/十三经注疏/shangshu_vols';
...
const CN2NUM = { '一': '01', '二': '02', '三': '03', '四': '04', '五': '05', '六': '06', '七': '07', '八': '08', '九': '09', '十': '10', '十一': '11', '十二': '12', '十三': '13', '十四': '14', '十五': '15', '十六': '16', '十七': '17', '十八': '18', '十九': '19', '二十': '20' };
const CN_NUMS = ['一', '二', '三', '四', '五', '六', '七', '八', '九', '十', '十一', '十二', '十三', '十四', '十五', '十六', '十七', '十八', '十九', '二十'];
