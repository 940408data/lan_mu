/**
 * 将春秋左传正义合并文本按卷分割为单独文件
 */
const fs = require('fs');
const path = require('path');

const mergedFile = 'input_data/十三经注疏/chunqiu-zuozhuan_merged.txt';
const outDir = 'input_data/十三经注疏/chunqiu-zuozhuan_vols';
...
// 支持"卷十九上"这样的格式
const volPattern = /^卷([一二三四五六七八九十百]+)[上下]?\s/;
let currentVol = null;
let currentLines = [];
const volData = {};
